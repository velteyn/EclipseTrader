...
public class ChangePercentageFactory extends AbstractProviderFactory {
    ...
    public class DataProvider implements IDataProvider {
        ...
        public IDataProviderFactory getFactory() {
            return ChangePercentageFactory.this;
        }
        ...
        public IAdaptable getValue(IAdaptable adaptable) {
            ...
            if (close != null && close.getPrice() != null && price != null && price.getPrice() != null) {
                Double value = (price.getPrice() - close.getPrice()) / close.getPrice() * 100.0;
    ...
    public ChangePercentageFactory() {
