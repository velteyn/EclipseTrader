...
package org.eclipsetrader.jessx.business.operations;


import org.eclipsetrader.jessx.business.ClientInputPanel;
import org.eclipsetrader.jessx.business.OperationCreator;
...
public class BestLimitOrder extends Order
{
    ...
    static {
        try {
            ...
            OperationCreator.operationFactories.put("BestLimitOrder", Class.forName("org.eclipsetrader.jessx.business.operations.BestLimitOrder"));
        }
