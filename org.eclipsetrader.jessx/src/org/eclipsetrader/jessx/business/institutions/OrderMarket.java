...
import org.eclipsetrader.jessx.business.InstitutionCreator;
...
public class OrderMarket extends Institution
{
    ...
    static {
        try {
            ...
            InstitutionCreator.institutionFactories.put("OrderMarket", Class.forName("org.eclipsetrader.jessx.business.institutions.OrderMarket"));
        }
