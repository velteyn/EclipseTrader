...
public class ImportDataPage extends WizardPage {
    ...
    public void createControl(Composite parent) {
        ...
        type.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                if (typeIndex != 0) {
                    setDate(to, Calendar.getInstance().getTime());
                }
    ...
    protected void restoreState() {
        ...
        if (dialogSettings != null) {
            ...
            if (dialogSettings.get(K_FROM_DATE) != null) {
                try {
                    setDate(from, new SimpleDateFormat("yyyyMMdd").parse(dialogSettings.get(K_FROM_DATE)));
                } catch (Exception e) {
                    // Do nothing
                }
            }
    ...
    public void saveState() {
        ...
        dialogSettings.put(K_FROM_DATE, new SimpleDateFormat("yyyyMMdd").format(getDate(from)));
